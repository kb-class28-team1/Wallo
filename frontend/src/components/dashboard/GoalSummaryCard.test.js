...
describe("GoalSummaryCard", () => {
  it("shows the confirmed goal details", () => {
    ...
    expect(wrapper.find(".goal-summary-card").classes()).toContain("app-card")
    expect(wrapper.find(".goal-summary-card .app-card__body").exists()).toBe(true)
  })
  ...
  it("shows the error state and emits retry", async () => {
    ...
    expect(wrapper.find(".goal-state").classes()).toContain("app-alert")
    expect(wrapper.find(".goal-state").classes()).toContain("app-alert--danger")
    expect(wrapper.find(".goal-state .app-button").exists()).toBe(true)
