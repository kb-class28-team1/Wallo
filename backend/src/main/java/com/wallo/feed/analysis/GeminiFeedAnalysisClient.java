...
public class GeminiFeedAnalysisClient implements FeedAnalysisClient, SavingFeedbackAwareFeedAnalysisClient {
    ...
    private String buildPrompt(
        ...
        return """
                ...
                summary는 한두 문장으로 작성하세요. 첫 부분에는 사용자가 무엇을 했는지 설명하고,
                이어서 화면에서 실제로 확인한 핵심 물품·재료와 개수를 자연스러운 한국어로 작성하세요.
                보이지 않는 물품이나 재료는 추가하지 말고 시장 가격·재료비·차액은 summary에서 추정하지 마세요.
                채집 물품의 시세와 총 가치, 요리의 음식점 판매가·재료비·차액은 서버가 계산해 뒤에 추가합니다.
