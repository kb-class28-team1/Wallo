...
import com.wallo.report.term.mapper.FinancialTermMapper;
 ...
 * 채워두고, {@link com.wallo.report.scheduler.FinancialTermCacheRefreshScheduler}가 주기적으로
...
public class FinancialTermMatchingServiceImpl implements FinancialTermMatchingService, InitializingBean {
     ...
     * 한 번, {@link com.wallo.report.scheduler.FinancialTermCacheRefreshScheduler}로 주기적으로 자동 호출됨).
