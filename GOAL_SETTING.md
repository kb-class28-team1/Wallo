...
| 계획 | `monthlyContribution` | 매달 추가로 마련할 수 있는 금액 | 필수 |
...
- 월 필요 금액 = 남은 금액 / 남은 개월 수(올림)
- 월 부족분 = 월 납입 가능액 - 월 필요 금액

결과는 `ACHIEVABLE`, `TIGHT`, `ADJUSTMENT_REQUIRED`, `ALREADY_ACHIEVED`로
구분하고 사용자에게 확정 또는 금액·기간 조정을 요청한다.
