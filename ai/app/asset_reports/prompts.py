...
1. 지출 급증: categoryChangeRate가 30 이상이면 선택합니다. 카테고리 지출이 지난달보다 늘었다는 점을 말하고, 이모지 없이 반드시 "지출 내역을 점검해보세요."로 마무리합니다.
...
- 지출 급증 스타일에서는 "🚀 점검해보세요." 또는 다른 이모지를 사용하지 말고, 제안 문장을 반드시 "지출 내역을 점검해보세요."로 작성합니다.
