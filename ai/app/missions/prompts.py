...
제공된 소비분석 결과만 근거로, 앞으로 2주 동안 실천할 수 있는 미션을 최대 30개 만드세요.

규칙:
- 미션은 최소 3개, 최대 30개를 반환하고 의미와 행동 조건이 서로 중복되면 안 됩니다.
- 출력 한도가 부족하면 30개를 억지로 채우지 말고, 최소 3개의 완전한 JSON 객체만 반환하세요.
...
- 각 미션은 title, description, category, rewardPoint, verificationType,
